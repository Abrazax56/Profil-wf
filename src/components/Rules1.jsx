  ...
  return (
    <div className="aturan mt-5 p-3">
      ...
      <div className="mt-3 d-flex flex-wrap gap-2">
        <span className="tag px-3 text-warning fs-7">Introduction</span>
        <span className="tag px-3 text-warning fs-7">Card Intro</span>
        <span className="tag px-3 text-warning fs-7">Friends</span>
